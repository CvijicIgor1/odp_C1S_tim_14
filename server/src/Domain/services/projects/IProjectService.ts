...
export interface IProjectService {
  ...
  addTag(projectId: number, tagId: number, userId: number): Promise<boolean>;
  removeTag(projectId: number, tagId: number, userId: number): Promise<boolean>;
  watchProject(projectId: number, userId: number): Promise<boolean>;
  unwatchProject(projectId: number, userId: number): Promise<boolean>;
  checkOwnerOrAdmin(projectId: number, userId: number, isAdmin: boolean): Promise<void>;
}